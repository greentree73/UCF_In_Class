...
function GreetingForm() {
  ...
  // TODO 4: in handleSubmit, build an input object from form data
  // TODO 5: call createGreeting({ variables: { input } })
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    // Example input object shape:
    // const input = { name: name.trim() };
    // await createGreeting({ variables: { input } });
  };
