...
// Input Type primer:
// - Input Types are GraphQL object shapes used as arguments (instead of many separate scalar args).
// - Example: mutation CreateQuestion($input: CreateQuestionInput!)
// - Apollo Client sends this as variables: { input: { ...fields } }
// - The server validates the shape against CreateQuestionInput / UpdateQuestionInput.
...
// - $input provides the updated fields as an UpdateQuestionInput object
