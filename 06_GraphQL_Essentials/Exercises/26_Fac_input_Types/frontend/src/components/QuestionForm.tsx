  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingQuestion) {
        ...
        // This object must match the GraphQL UpdateQuestionInput type shape
        // defined by the server schema (field names and value types).
        ...
        await updateQuestion({
          ...
          // Apollo Client serializes this variables object and sends it as:
          // { "id": "...", "input": { title, body, tags } }
          // GraphQL then validates `input` against UpdateQuestionInput before resolver execution.
        ...
        // Create new question
        // This object must match the GraphQL CreateQuestionInput type shape.
        ...
        await createQuestion({
          ...
          // Apollo Client sends the payload as variables, and GraphQL enforces
          // the CreateQuestionInput contract (required fields + field types).
